...
var Driver = module.exports = function Driver() {
  ...
  this.commands = {
    ...
    get_up: this.getUp,
    distance_drive: this.distanceDrive
  };
};
...
Driver.prototype.distanceDrive = function(direction, distance, turnDirection, turnAngle, callback) {
...
Driver.prototype.driveForwardTime = function(speed, time, callback) {
...
Driver.prototype.driveBackwardTime = function(speed, time, callback) {
  var packet = new Buffer(3);
...
Driver.prototype.turnLeftAngle = function(angle, speed, callback) {
  var packet = new Buffer(3);
...
Driver.prototype.turnRightAngle = function(angle, speed, callback) {
  var packet = new Buffer(3);
